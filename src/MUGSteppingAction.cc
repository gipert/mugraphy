...
MUGSteppingAction::MUGSteppingAction(MUGEventAction* eventaction) : fEventAction(eventaction) {
...
void MUGSteppingAction::DefineCommands() {
  ...
  fMessenger = std::make_unique<G4GenericMessenger>(this, "/MUG/Stepping/",
      "Commands for controlling particle tracking");

  // TODO: this is not the altitude but the coordinate in the world
  fMessenger
      ->DeclarePropertyWithUnit("KillTrackBelowAltitude", "m",
          MUGSteppingAction::fLowestAltitudeForTracking)
