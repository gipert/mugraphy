...
void MUGMaterialTable::InitializeMaterials() {
  ...
  fMaterialAliases = {{"Vacuum", "G4_Galactic"}, {"Air", "G4_AIR"}, {"Concrete", "G4_CONCRETE"},
      {"Water", "G4_WATER"}, {"ScintPlastic", "G4_PLASTIC_SC_VINYLTOLUENE"}};
  ...
  auto mat_enr_ge = new G4Material("MUG_EnrichedGermanium", density = 5.54, n_components = 1,
