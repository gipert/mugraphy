...
function(find_config_script NAME)
    ...
    if(${NAME}_CONFIG_EXECUTABLE)
        # find header paths
        execute_process(COMMAND ${${NAME}_CONFIG_EXECUTABLE} --cflags
        ...
        # find lib paths
        execute_process(COMMAND ${${NAME}_CONFIG_EXECUTABLE} --libs
        ...
        set(INCLUDE_DIRS_FROM_CONFIG ${INCLUDE_DIRS} PARENT_SCOPE)
        set(LIBS_DIRS_FROM_CONFIG ${LIBS_DIRS} PARENT_SCOPE)

        mark_as_advanced(
            ${NAME}_CONFIG_EXECUTABLE
            INCLUDE_DIRS_FROM_CONFIG
            LIBS_DIRS_FROM_CONFIG)
    else()
