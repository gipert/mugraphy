...
macro(get_version_info)
  ...
  if(_git_revision STREQUAL "")
    message(
      WARNING
        "Cannot determine ${PROJECT_NAME} revision, is the .git directory there? Did you fetch tags from remote?"
    )
    set(PROJECT_VERSION "unknown")
    set(PROJECT_VERSION_MAJOR "unknown")
  else()
    if(${_git_revision} MATCHES "^v([0-9]+)\\.([0-9]+)\\.([0-9]+)(.*)")
      string(REGEX REPLACE "v([0-9]+)\\.([0-9]+)\\.([0-9]+)(.*)?" "\\1;\\2;\\3;\\4" _matches
                           ${_git_revision})
      ...
      message(
        WARNING
          "Could not determine major/minor/patch fields from version string '${_git_revision}'")
      set(PROJECT_VERSION "unknown")
      set(PROJECT_VERSION_MAJOR "unknown")
    endif()
  endif()
