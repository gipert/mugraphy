...
# df = uproot.concatenate("hstat/*.root:ntuples")
...
h1 = (
    Hist.new
    .Reg(100, -1, 1, name='x', label=r'$\tan\theta_x$')
...
h2 = Hist.new.Reg(100, 0, np.pi, name='x', label=r'Azimuthal angle $\theta$ (deg)').Double()
h2.fill(theta)
# h2.plot(yerr=False)
